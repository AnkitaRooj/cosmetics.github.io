        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5 ">
                      ...
                      <img src="images/eyebrow.jpg" class="img-fluid rounded-start " alt="..." >
                      
                  </div>
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">EXPRESS BROW
                            2-IN-1 PENCIL AND POWDER, EYEBROW MAKEUP</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 463</strong></p>
                      <p class="card-text lead">
                      <div class="accordion">
                        <div class="contentBx">
                          <details>
                              <summary class="font label">About</summary>
                              <p class="font detail">Try Express Brow 2-In-1 Eyebrow Pencil + Powder by Maybelline for full natural-looking eyebrows, teardrop tip to shape brows and a powder sponge to fill and smooth.</p>
                          </details>
                          <details>
                              <summary class="label font">Benefits</summary>
                              <p class="font detail" >Grab the express to easy, full brows. Meet Maybelline New York’s Express Brow 2-In-1 Pencil + Powder. It’s our fastest all-in-one tool for instantly fuller, natural- looking eyebrows. This eyebrow duo has a precise teardrop tip on one side that easily defines and shapes brows and a powder packed sponge on the other side that fills and smoothes, delivering brows that wow. Get your ticket to an effortless filled brow. Ophthalmologist tested. Suitable for contact wearers.
                                </p>
                          </details>
                          <details>
                              <summary class="label font" >How To Apply</summary>
                              <p class="font detail" >Step 1. Define and set eyebrows with the defining wax pencil using short and light strokes.<br>
                                Step 2. Fill in with the powder along the natural brow contour.
                            </p>
                          </details>
                          <div class="container">
                              <img src="images/eyebrowW.jpg" alt="" srcset="">
                          </div>
                        </div>
                        </div>
                      </p>
