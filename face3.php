        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5">
                      ...
                      <img src="images/face3.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">Lakmé Absolute Skin Natural Mousse</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 578</strong></p>
                      ...
                      <div class="accordion">
                        <div class="contentBx">
                          ...
                          <div class="container">
                              <img src="images/faceW3.jpg" alt="" srcset="" style="max-width: 100%;
                              height: auto;">
                          </div>
                        </div>
                        </div>
