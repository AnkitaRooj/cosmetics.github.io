        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5">
                      ...
                      <img src="images/lip2.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">Lakme Lipstick Scarlet Surge (Matte)</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 393</strong></p>
                      <p class="card-text lead">
                      <div class="accordion">
                        <div class="contentBx">
                          <details>
                              <summary class="font label">About</summary>
                              <p class="font detail">14-hour intense matte for an unstoppable you
                                With 2X primer for a long-lasting, smooth matte finish
                                Comfortable on lips with an intense color payoff
                                Glides smoothly onto lips for easy and quick application
                                Available in 20 vibrant and stunning matte shades that compliment all skin tones
                                No touch-ups
                                </p>
                          </details>
                          <details>
