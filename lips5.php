        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5">
                      ...
                      <img src="images/lip5.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">Lakme Lipstick Burgundy Passion (Matte)</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 524</strong></p>
