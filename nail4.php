        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5">
                      ...
                      <img src="images/nail4.jpg" class="img-fluid rounded-start" alt="..." style="width: 120px;
                      height: 120px;
                  ...
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">Maybelline New York Color Show Nail Lacquer</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 235</strong></p>
