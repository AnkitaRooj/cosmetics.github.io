        ...
        <div class="container shadow p-3 mb-5 bg-body rounded">
              ...
              <div class="row">
                  <div class="col-md-5">
                      ...
                      <img src="images/nail5.jpg" class="img-fluid rounded-start" alt="..." style="width: 120px;
                      height: 120px;
                  ...
                  <div class="col-md-7">
                      <div class="card-body">
                          <h5 class="font cd-title card-title">Maybelline Color Show Nail Enamel, Denim dash</h5>
                      ...
                      <p class=" card-text lead" ><strong>₹ 160</strong></p>
                      <p class="card-text lead">
                      <div class="accordion">
                        <div class="contentBx">
                          <details>
                              <summary class="font label">About</summary>
                              <p class="font detail">Easy-flow brush<br>
                                Formaldehyde, DBP and Toluene free</p>
                          </details>
                          <details>
                              <summary class="label font">Benefits</summary>
                              <p class="font detail" >Lets your nails make a fashion statement<br> Get gel based formula. Infused with Colour Popping Pigments. <br>CHIP- RESISTANT. Allows you to flauntyour perfectly polished nails at all times.<br>EASY FLOW BRUSH to give your nails a stylish makeover.<br>
                                </p>
                          </details>
                          <details>
